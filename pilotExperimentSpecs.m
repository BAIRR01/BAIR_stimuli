function [experimentSpecs, whichSite, selectionMade] = pilotExperimentSpecs(varargin)
...
sites       = {'nyu3t'; 'nyumeg'; 'nyuecog'; 'umc3t'; 'umc7t'; 'umcecog'; 'umcor'};
displays    = {'CBI_Propixx'; 'meg_lcd'; 'SoMMacBook'; 'UMC_3TLCD'; 'UMC_7TDLP'; 'UMC_EMU'; 'UMC_OR'};
modalities  = {'fMRI'; 'MEG'; 'ECoG'; 'fMRI'; 'fMRI'; 'ECoG'; 'ECoG'};
radii       = [12.4; 11; 11.8; 8.3; 6.4287; 11.8; 9.2];
trigger     = {'5'; '5'; '5'; 49; 49; '5'; '5'};
serialport  = [false; false; false; true; true; true; true];
eyetracker  = [false; true; false; false; false; false; false];
photodiode  = [false; false; true; false; false; false; false];
